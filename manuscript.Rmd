...
Potential environmental drivers of shallow crab community structure were assembled from a previous study on environmental drivers of genetic diversity [@selkoeDNACoralReef2016], NOAA's National Coral Reef Monitoring Program (NCRMP), the Pacific Islands Ocean Observing System (PacIOOS), NASA Physical Oceanography Distributed Active Archive Center (PO.DAAC), and NASA Ocean Biology Distributed Active Archive Center (OB.DAAC) ([@tbl:env_table]). For details on how sea-surface temperature and chlorophyll data were compiled and aggregated, see Supplemental material. Due to logistical limitations, environmental data were collected only for shallow samples ($\le$ 30 m).
