...
# Tables {-}
```{r tbl-rda,results="asis",dependson="rda-analysis"}
print_table(rda_table,"tbl_rda","Significant marginal terms in the dbRDA analysis of crab community variation across the Hawaiian Archipelago",hdr_case="none",accuracy=0.001)
```
